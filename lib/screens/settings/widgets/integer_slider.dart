...
/// Creates a list of three widgets; an [Icon], a [Text] and a [Slider].
///
/// The user can use the slider to set the value of [notifier]. [notifier] can
/// take an integer value between [min] and [max], both inclusive. This value
/// is always n times [stepSize] bigger than [min], where n is an integer bigger
/// than or equal to zero. [max] - [min] should be a multiple of [stepSize].
/// [stepSize] takes the value 1 if omitted.
///
